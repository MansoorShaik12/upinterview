...
const handleSubmit = async (e) => {
  ...
  return (
    <>
      ...
      >
        <div
          className={`fixed inset-y-0 right-0 z-50 w-1/2 bg-white shadow-lg transition-transform duration-5000 transform ${
        ...
        >
            ...
            <div className="flex justify-between items-center p-4">
              ...
              <button onClick={onClose} className="focus:outline-none"> {/* Close button */}
                <svg
                  className="h-6 w-6"
                  fill="none"
                  stroke="currentColor"
