                      ...
                      <div className="flex mb-4">
                        ...
                        <div className="relative flex-grow">
                          <div className="relative mb-3">
                            <div
                              disabled={!selectedCandidate}
                              className={`border-b focus:border-black focus:outline-none min-h-6 bg-white mb-5 h-auto w-full relative mt-2 ${errors.Interviewer
                                ? "border-red-500"
                                : "border-gray-300 focus:border-black"
                                }`}
                              onClick={selectedCandidate ? () => handleInterviewerFieldClick(index) : null}
                            >
                            ...
                            {currentPage !== "/outsourceinterview" && (
                              <MdArrowDropDown className="absolute top-0 text-gray-500 text-lg mt-1 cursor-pointer right-0" onClick={selectedCandidate ? () => handleInterviewerFieldClick(index) : null} />
                            )}
                          </div>
                                        ...
                                        <div>
                                          {teamData.slice(0, 4).map((team) => (
                                            <div
                                              ...
                                              onClick={() => handleTeamMemberSelect(team, index)} // Pass index
                                            >
