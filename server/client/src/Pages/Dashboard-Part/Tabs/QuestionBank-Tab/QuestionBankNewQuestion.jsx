  ...
  return (
    ...
    >
      <div
        ...
        className={`fixed inset-y-0 right-0 z-40 w-1/2 bg-white shadow-lg transition-transform duration-5000 transform ${isOpen ? "translate-x-0" : "translate-x-full"
          }`}
      >
        {/* Header */}
              ...
              {showMcqFields && (
                <div className="">
                  <div className="flex items-center gap-2 mb-2">
                    <label className="block mb-2 text-sm font-medium text-gray-900 ml-5">
                      Options
                    </label>
                    <IoAdd
