...
const AddQuestion1 = React.forwardRef(({ isOpen, onClose, sectionName, onQuestionAdded, selectedAssessmentType, selectedQuestion, onSave, updateQuestionList }, ref) => {
  ...
  const handleSubmit = async (e, isSaveAndNext, _id) => {
    ...
    try {
      const response = await axios.put(`${process.env.REACT_APP_API_URL}/updateNewQuestion/${_id}`, questionData);
          ...
          <div className="fixed top-20 bottom-16 overflow-auto w-full">
            <form className=" p-4" onSubmit={handleSubmit}>
              <div>
                ...
                <div className="flex gap-5 mb-5">
                  {selectedQuestionType !== "Programming" && (
                    <div>
                        ...
                        <div key={index} className="flex gap-5 items-center relative mb-4">
                          ...
                          <div className="flex-grow flex items-center relative">
                            ...
                            <textarea
                              ...
                              value={mcqInputType[index] === 'text' ? mcqTextContent[index] || '' : mcqCodeContent[index] || ''}
