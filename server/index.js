...
//     console.log('Locations fetched from database:', locations); // Add this line
//     res.json(locations);
//   } catch (error) {
//     console.error('Error fetching locations:', error); // Add this line
...
//   try {
//     const skills = await SkillMaster.find({});
//     console.log('Skills fetched from database:', skills); // Add this line
//     res.json(skills);
//   } catch (error) {
//     console.error('Error fetching skills:', error); // Add this line
//     res.status(500).json({ message: error.message });
//   }
// });
...
//     console.log('Roles fetched from database:', roles); // Add this line
//     res.json(roles);
//   } catch (error) {
...
//     console.log('Technology fetched from database:', technology); // Add this line
//     res.json(technology);
//   } catch (error) {
//     console.error('Error fetching technology:', error); // Add this line
//     res.status(500).json({ message: error.message });
//   }
// });
...
// app.get('/industries', async (req, res) => {
//   try {
//     const industries = await IndustryMaster.find({});
//     console.log('Industries fetched from database:', industries); // Add this line
//     res.json(industries);
//   } catch (error) {
//     console.error('Error fetching industries:', error); // Add this line
//     res.status(500).json({ message: error.message });
//   }
// });
