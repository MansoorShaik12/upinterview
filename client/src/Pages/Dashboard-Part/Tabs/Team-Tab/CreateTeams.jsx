...
import { FaPlus, FaMinus, FaSearch, FaEdit, FaTrash, FaTimes } from "react-icons/fa";
  ...
  return (
    <>
     ...
     <div className="fixed top-0 w-full bg-white border-b">
      ...
      {/* Content */}
      <div className="fixed top-16 bottom-16 overflow-auto right-0 p-5">
        {currentPage === "form" && (
          <form onSubmit={handleNext}>
            <div className="grid grid-cols-4 text-sm z-50">
                        ...
                        <div className='relative'>
                          ...
                          {showPopup && selectedDay === day && (
                            ...
                            >
                              ...
                              <button onClick={handlePaste} className="mt-4 bg-blue-500 text-white py-1 px-4 rounded">
                                Duplicate
                              </button>
